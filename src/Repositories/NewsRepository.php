...
class NewsRepository implements NewsRepositoryInterface
{
    ...
    public function deleteLanguage($uuid, $lang) {
        $news = News::where('uuid', $uuid)->first();
        $news->translation()->where('language_id', $lang)->update(['status' => 0]);
        $news->tags()->where('language_id', $lang)->where('tagable_id', $news->id)->delete();
    }
    ...
    public function update($update) {
        ...
        $news->translation()
            ->updateOrCreate([
                ...
                'brief' => $update['brief'],
                'desc' => $update['desc'],
                'image_name' => $update['originalFileName'] ?? null,
    ...
    public function create($create) {
        ...
        $news->translation()->create([
            ...
            'image_name' => $create['originalFileName'] ?? null,
